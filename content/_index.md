  ...
  - block: markdown
    ...
    content:
      ...
      text: |-
        ...
        <ul style="font-size:17px">
          <li><a href="http://andonisergiou.com/">Dr Andoni Sergiou</a>, PhD student, 2020-2025; passed with minor corrections</li>
        ...
        <ul style="font-size:17px">
          ...
          <li><a href="https://www.researchgate.net/profile/Andre-Nascimento-28">Prof André Luiz Borba do Nascimento</a>, visiting PhD student from Federal Rural University of Pernambuco, Brazil, March-August 2017</li>
        </ul>
    design:
      columns: '1'
  - block: markdown
